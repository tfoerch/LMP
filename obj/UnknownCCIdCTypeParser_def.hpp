#ifndef LMP_OBJ_UNKNOWN_CC_ID_PARSER_DEF_HPP_
#define LMP_OBJ_UNKNOWN_CC_ID_PARSER_DEF_HPP_
/*
 * UnknownCCIdCTypeParser_def.hpp
 *
...
namespace lmp
{
  namespace obj
  {
    namespace parser
    {
      ...
      unknown_cc_id_ctype_type const unknown_cc_id_ctype = "unknown_cc_id_ctype";


      ///////////////////////////////////////////////////////////////////////////
      // Grammar
      ///////////////////////////////////////////////////////////////////////////
      lmp::WORD unknown_cc_id_ctype_obj_length;
      ...
      auto const unknown_cc_id_ctype_def =
      ...
      struct unknown_cc_id_ctype_class : x3::annotate_on_success/*, error_handler_base*/ {};
    } // namespace parser

    parser::unknown_cc_id_ctype_type const& unknown_cc_id_ctype()
    {
      return parser::unknown_cc_id_ctype;
    }
  } // namespace obj
} // namespace lmp

#endif /* LMP_OBJ_UNKNOWN_CC_ID_PARSER_DEF_HPP_ */
