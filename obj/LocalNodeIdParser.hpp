...
namespace lmp
{
  namespace obj
  {
    namespace parser
    {
      ...
      struct local_node_id_grammar : qi::grammar<Iterator, nodeid::ast::LocalNodeId()>
      {
        local_node_id_grammar();
        lmp::obj::parser::object_header_fix_length_grammar<Iterator,
                                                           nodeid::ClassType,
                                                           nodeid::ClassType::LocalNodeId>  object_header;
        qi::rule<Iterator, nodeid::ast::LocalNodeId()>                                      local_node_id_rule;
      };
